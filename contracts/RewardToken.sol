...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint64 previousDepositFee;
    uint64 previousWithdrawFee;
    ...
    modifier onlyAdmin() {
        require(msg.sender == _admin, "ERC20: Must be admin");
        _;
    }

    // GETTERS

    /// @notice This function returns admin
    function admin() public view returns(address) {
        return _admin;
    }

    /// @notice This function changes returns reward period
    function getRewardPeriod() public view returns (uint256){
        return rewardPeriod;
    }

    /// @notice This function returns the deposit Fee
    function getDepositFee() public view returns(uint64){
        return depositFee;
    }

    /// @notice This function retuns the withdraw Fee
    function getWithdrawFee() public view returns(uint64){
        return withdrawFee;
    }
    ...
    /// @notice This function allows the tokenOwner to mint new tokens
